...
export function IconWorkflow({ className }: IconProps) {
  return (
    ...
    >
      ...
      />
      <path strokeLinecap="round" d="M10 9h4M10 15h4M9 10v4M15 10v4" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M8 7V4m8 3V4M6 11h12v5a3 3 0 01-3 3H9a3 3 0 01-3-3v-5z"
      />
...
export function IconChart({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 15l3-4 4 5 5-8" />
    </svg>
  );
}
...
export function ServiceIcon({
  ...
  name: (typeof import("@/lib/constants").services)[number]["icon"];
  className?: string;
}) {
  const icons = {
