...
export function AgentDemo() {
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_80%_50%,rgba(6,182,212,0.12),transparent)]"
        aria-hidden
      />

      <div className="relative mx-auto grid max-w-6xl items-start gap-12 lg:grid-cols-2 lg:gap-16">
        <div className="lg:sticky lg:top-24">
          <p className={brand.eyebrow}>Demo interactiva</p>
